 ...
 */
fun ChartDataCollection<ChartData>.maxYValue() = data.maxOf { it.yValue }

/*
 * Returns the maximum x-value among all the data points in the ChartDataCollection.
 */
fun ChartDataCollection<ChartData>.maxXValue() = data.maxOf { it.xValue.toString().length }

/*
 * Returns the minimum y-value among all the data points in the ChartDataCollection.
 */
fun ChartDataCollection<ChartData>.minYValue() = data.minOf { it.yValue }
